    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
                ...
                @if (Auth::user() and Auth::user()->role == 'Admin')
                        ...
                        <a href="{{ route('checkposts') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Check new posts</a>
                @endif
                @if (Auth::user() and Auth::user()->role == 'User') 
                        <a href="{{ route('createpost') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Create post</a>
                        <a href="{{ route('showposts') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Show all posts</a>
...
<footer>
    <div class="ml-4 text-center text-sm text-black-500 sm:text-center sm:ml-0">
